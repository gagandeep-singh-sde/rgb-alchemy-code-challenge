    ...
    if (colorArray.length) {
      ...
      for (let row = 1; row < userDetails.height + 1; row++) {
        for (let col = 1; col < userDetails.width + 1; col++) {
          ...
          result = (1/255) * (1/Math.sqrt(3)) * Math.sqrt(Math.pow((targetColor.r - r), 2) + Math.pow((targetColor.g - g), 2) + Math.pow((targetColor.b - b), 2)) * 100
          console.log(result);
          if(result < 10) {
    ...
    if (colorArray.length) {
      ...
      if (clickedElement.xPos === 0) {
        for (let i = 1; i <= userDetails.height; i++) {
          setColorArray((prevState) => {
            let r, g, b;
            if (!prevState[userDetails.height - i + 1][clickedElement.yPos].r && !prevState[userDetails.height - i + 1][clickedElement.yPos].g && !prevState[userDetails.height - i + 1][clickedElement.yPos].b ) {
      ...
      if (clickedElement.xPos === userDetails.height + 1) {
        for (let i = 1; i <= userDetails.height; i++) {
          setColorArray((prevState) => {
            let r, g, b;
            if (!prevState[i][clickedElement.yPos].r && !prevState[i][clickedElement.yPos].g && !prevState[i][clickedElement.yPos].b ) {
              r = (clickedElement.r * i) / (userDetails.height + 1);
              g = (clickedElement.g * i) / (userDetails.height + 1);
              b = (clickedElement.b * i) / (userDetails.height + 1);
            } else {
            ...
            return [
              ...prevState,
              (colorArray[i][clickedElement.yPos].r =
                r * f),
              (colorArray[i][clickedElement.yPos].g =
                g * f),
              (colorArray[i][clickedElement.yPos].b =
                b * f),
            ];
          });
        }
      ...
      if (clickedElement.yPos === 0) {
        for (let j = 1; j <= userDetails.width; j++) {
          setColorArray((prevState) => {
            let r, g, b;
            if (!prevState[clickedElement.xPos][userDetails.width - j + 1].r && !prevState[clickedElement.xPos][userDetails.width - j + 1].g && !prevState[clickedElement.xPos][userDetails.width - j + 1].b ) {
      ...
      if (clickedElement.yPos === userDetails.width + 1) {
        for (let j = 1; j <= userDetails.width; j++) {
          setColorArray((prevState) => {
            let r, g, b;
            if (!prevState[clickedElement.xPos][j].r && !prevState[clickedElement.xPos][j].g && !prevState[clickedElement.xPos][j].b ) {
              r = (clickedElement.r * j) / (userDetails.width + 1);
              g = (clickedElement.g * j) / (userDetails.width + 1);
              b = (clickedElement.b * j) / (userDetails.width + 1);
            } else {
            ...
            return [
              ...prevState,
              (colorArray[clickedElement.xPos][j].r =
                r * f),
              (colorArray[clickedElement.xPos][j].g =
                g * f),
              (colorArray[clickedElement.xPos][j].b =
                b * f),
            ];
          });
        }
